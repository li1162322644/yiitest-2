...
class Upload extends Model
{
    ...
    public function init()
    {
        ...
        $this->_appendRules = [[['file'], 'file', 'extensions' => $extensions],];
    }
    ...
    public function upImage()
    {
        ...
        if ($model->validate()) {
            ...
            return ['code' => 0, 'url' => Yii::$app->params['domain'] . $successPath . $fileName, 'attachment' => $successPath . $fileName];
        } else {
            $errors = $model->errors;
            return ['code' => 1, 'msg' => current($errors)[0]];
        }
    }
}